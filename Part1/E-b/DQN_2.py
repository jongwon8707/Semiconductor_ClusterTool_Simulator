...
class Agent():
    ...
    def evaluate(self, num_episodes=10, render=False):
        ...
        model3_path = './환경B_0.99_384/eqp-scheduler-v0.pt'
    ...
    def compare_and_plot(self, num_episodes=10):
        ...
        plt.xticks([0, 1, 2, 3, 4], ['Model (Env A) w/ 0.99', 'Model (Env A) w/ 0.9995','Model (Env B) w/ 0.99', 'Random', 'Rule1'])
        ...
        print(f"Model (Env A) w/ 0.9995 - Mean: {np.mean(model2_wafers):.2f}, Std: {np.std(model2_wafers):.2f}")
        print(f"Model (Env B) w/ 0.99 - Mean: {np.mean(model3_wafers):.2f}, Std: {np.std(model3_wafers):.2f}")
...
if __name__ == '__main__':
    ...
    dql.compare_and_plot(num_episodes=50)